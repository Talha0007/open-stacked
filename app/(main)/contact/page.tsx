    ...
    <main className="pt-32 pb-20 min-h-screen">
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        <header className="text-center mb-20">
          ...
          <h1 className="text-5xl md:text-8xl font-black text-black mt-6 tracking-tighter italic uppercase">
            Get in{" "}
            ...
            <div className="p-10 rounded-[2.5rem] border border-slate-200 bg-white/80 backdrop-blur-xl relative overflow-hidden group">
              ...
              <div className="space-y-8 relative z-10">
                <div className="flex items-start gap-6 group/item">
                  <div className="p-4 rounded-2xl bg-slate-100 text-cyan-500 border border-slate-300 group-hover/item:bg-cyan-500 group-hover/item:text-white transition-all">
                    <Mail size={24} />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-6 group/item">
                  <div className="p-4 rounded-2xl bg-slate-100 text-blue-500 border border-slate-300 group-hover/item:bg-blue-500 group-hover/item:text-white transition-all">
                    <Globe size={24} />
                  </div>
                  <div>
                    <div className="text-slate-500 text-[10px] font-mono uppercase tracking-widest mb-1">
