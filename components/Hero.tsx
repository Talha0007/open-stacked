...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen w-full flex flex-col justify-between bg-transparent text-white p-4 sm:p-8 md:p-12 xl:p-16 overflow-hidden"
    >
      ...
      <div className="w-full flex justify-between items-start pointer-events-none z-20">
        ...
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="hidden md:flex items-center gap-2 text-[10px] font-mono tracking-widest text-slate-500"
        >
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-2 md:px-6 pointer-events-none my-auto py-8 lg:py-0 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
        ...
        <div className="col-span-1 lg:col-span-7 space-y-8 text-center lg:text-left flex flex-col items-center lg:items-start">
          <div className="space-y-4">
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className="text-5xl sm:text-7xl md:text-8xl lg:text-[7.5rem] xl:text-[9rem] font-black leading-[0.85] tracking-tighter uppercase text-white"
            >
              OPEN <br />
          ...
          <motion.p
            ...
            initial="hidden"
            animate="visible"
            className="text-base sm:text-xl md:text-2xl text-slate-300 max-w-xl font-light leading-relaxed border-t-2 lg:border-t-0 lg:border-l-2 border-cyan-500/30 pt-4 lg:pt-0 lg:pl-6"
          >
          ...
          >
            ...
            <Link href="/docs" className="w-full sm:w-auto">
              <button className="group w-full sm:w-auto px-8 py-4.5 rounded-sm border border-white/10 bg-white/5 backdrop-blur-md font-medium text-base hover:bg-white/10 transition-all flex items-center justify-center gap-2">
        ...
        {/* Uses low opacities and high blur so the centered Globe tracks behind it beautifully */}
        <div className="col-span-1 lg:col-span-5 flex flex-col gap-4 w-full max-w-md mx-auto lg:mx-0">
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="p-6 rounded-xl border border-white/5 bg-black/30 backdrop-blur-xl pointer-events-auto group hover:border-cyan-500/20 transition-all duration-500 shadow-2xl"
          >
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="p-6 rounded-xl border border-white/5 bg-black/30 backdrop-blur-xl pointer-events-auto group hover:border-blue-500/20 transition-all duration-500 shadow-2xl"
          >
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="p-5 rounded-xl border border-white/5 bg-black/20 backdrop-blur-md flex items-center justify-between pointer-events-auto group hover:border-purple-500/20 transition-all duration-500"
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-base font-mono font-bold tracking-tight text-slate-200">
                  ~14.2MS AVERAGE
                </div>
              </div>
            </div>
      ...
      <div className="w-full z-20 px-4 md:px-6 opacity-20 pointer-events-none mt-auto pt-6 lg:pt-0">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-2 text-[9px] font-mono tracking-[0.3em] uppercase text-center sm:text-left">
