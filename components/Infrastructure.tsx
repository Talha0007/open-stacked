    ...
    <section className="relative py-16 md:py-22 overflow-hidden border-t border-slate-200/50">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            {steps.map((step, idx) => (
              ...
              >
                <div className="relative z-10 flex-shrink-0">
                  <div className="w-11 h-11 rounded-full bg-white border border-slate-300 flex items-center justify-center text-cyan-500 font-mono text-sm group-hover:border-cyan-500/50 transition-colors shadow-md">
                    {step.stage}
                  </div>
                </div>

                <div
                  className={`flex-1 p-8 rounded-3xl border border-slate-200 bg-gradient-to-br ${step.color} to-transparent backdrop-blur-sm group-hover:border-slate-300 transition-all duration-500`}
                >
        ...
        <motion.div
          ...
          className="mt-20 p-8 rounded-2xl bg-slate-50/50 border border-slate-200 text-center"
        >
